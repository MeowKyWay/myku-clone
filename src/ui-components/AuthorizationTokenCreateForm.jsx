...
import { createAuthorizationToken } from "../graphql/mutations";
const client = generateClient();
export default function AuthorizationTokenCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAuthorizationToken.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AuthorizationTokenCreateForm")}
      {...rest}
    >
      <TextField
        label="Token"
